...
def load_tile_surfaces(extra_small_size,small_size, large_size,extra_large_size,door_destonation=None):
    ...
    # ground-specific tiles (two-letter F* keys)
        ...
        'CRR':load_tile("red_small.png",small_size),
        'CRRL':load_tile("red_big.png",small_size),
        'CRO':load_tile("orange_small.png",small_size),
        'CROL':load_tile("orange_big.png",small_size),
        'CRG':load_tile("green_small.png",small_size),
        'CRGL':load_tile("greed_big.png",small_size),
        'CRT':load_tile("teal_small.png",small_size),
        'CRTL':load_tile("teal_big.png",small_size),
        'CRB':load_tile("cyan_small.png",small_size),
        'CRBL':load_tile("cyan_big.png",small_size),
        'CRDB':load_tile("dark_blue_small.png",small_size),
        'CRDBL':load_tile("dark_blue_big.png",small_size),
        'CRPU':load_tile("purple_small.png",small_size),
        'CRPUL':load_tile("purple_big.png",small_size),
        'CRP':load_tile("pink_small.png",small_size),
        'CRPL':load_tile("pink_big.png",small_size),
        'CRS':load_tile("silver_small.png",small_size),
        'CRSL':load_tile("silver_big.png",small_size),
